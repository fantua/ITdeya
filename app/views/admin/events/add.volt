...
{{ form('admin/events/add', 'class': 'form-horizontal', 'role': 'form') }}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-10" id="data_1">
            <label style="padding-right: 25px;">Назва: <input type="text" class="form-control" name="data[1][name]" required style="display: inherit;width: 200px;"></label>
            <label style="padding-right: 25px;">Тип: <select class="form-control" style="display: inherit;width: 100px" name="data[1][type]"><option value="text">text</option><option value="textarea">textarea</option></select></label>
            <label><input type="checkbox"  name="data[1][required]" checked> Обов`язкове</label>
        </div>
